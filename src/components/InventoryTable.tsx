  ...
  if (items.length === 0) {
    return (
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-12 text-center transition-colors duration-300">
          ...
          <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">{t('inventory.table.noItems')}</h3>
          <p className="text-gray-500 dark:text-gray-400">{t('inventory.table.noItemsSubtitle')}</p>
        </div>
    );
  }
                    ...
                    <tr key={item.id} className="hover:bg-gray-50 dark:hover:bg-gray-900/40 transition-colors duration-150">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex flex-col">
                          <span className="text-sm font-medium text-gray-900 dark:text-gray-100">{item.quantity} {t('inventory.table.units')}</span>
